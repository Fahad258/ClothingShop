...
namespace clothingshopproject.Service
{
    public class EmailService : IEmailService
    {
        ...
        {
            userEmailOptions.Subject = UpdatePlaceHolders("Hello {{UserName}}, This is test Email from Clothing shop web Application", userEmailOptions.PlaceHolders) ;
        ...
        private async Task SendEmail(UserEmailOptions userEmailOptions)
        {
            MailMessage mail = new MailMessage
            {
                ...
                IsBodyHtml = _smtpconfig.IsBordyHTML
